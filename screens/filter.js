...
const styles = StyleSheet.create({
    ...
    locationBox: {
        borderWidth: 1,
        borderColor: '#3b82f6',  // Adjust color as needed
        borderRadius: 10,        // Rounded corners
        paddingVertical: 8,      // Vertical padding inside box
        paddingHorizontal: 12,   // Horizontal padding inside box
        marginLeft: 10,          // Space between checkbox and box
    },
    locationIcon: {
