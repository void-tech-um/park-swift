...
function ListYourSpaceScreen() {
  ...
  const [chooseSize, setSize] = React.useState('size');
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scrollView}>
        <View>
          ...
          <Text style={styles.headerText}>Parking Space Size</Text>
          <View style={styles.sizeContainer}>
            <TouchableOpacity
              style={[styles.option, chooseSize === 'small' ? styles.selectedOption : null]}
            ...
            <TouchableOpacity
              style={[styles.option, chooseSize === 'medium' ? styles.selectedOption : null]}
            ...
            <TouchableOpacity
              style={[styles.option, chooseSize === 'large' ? styles.selectedOption : null]}
